...
const Events = () => {
  ...
  return (
    <section id="events" className="py-16">
      ...
      <div className="container mx-auto px-4 mt-16"> {/* เพิ่ม mt-16 เพื่อสร้างระยะห่าง */}
        ...
        <div className="flex justify-center items-center mb-6">
          ...
          <button
            className="bg-gray-200 rounded-full w-8 h-8 flex items-center justify-center mx-1"
        ...
        {monthEvents.map((event, index) => (
          <div
            key={index}
            className={`${event.color} p-6 rounded-md mb-4 cursor-pointer`}
